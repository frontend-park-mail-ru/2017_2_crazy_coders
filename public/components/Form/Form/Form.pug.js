...
pug_html = pug_html + "\u003Cinput" + (" class=\"form__input\""+pug_attr("type", field.attrs.type, true, false)+pug_attr("placeholder", field.attrs.placeholder, true, false)+pug_attr("name", field.attrs.name, true, false)) + "\u002F\u003E";
      }
  } else {
    var $$l = 0;
...
pug_html = pug_html + "\u003Cinput" + (pug_attr("class", pug_classes(["form__input",data.buttons[0].attrs.class], [false,true]), false, false)+pug_attr("type", data.buttons[0].attrs.type, true, false)+pug_attr("value", data.buttons[0].attrs.value, true, false)+pug_attr("id", data.buttons[0].attrs.id, true, false)) + "\u002F\u003E\u003C\u002Fform\u003E";
;pug_debug_line = 16;pug_debug_filename = ".\u002Fpublic\u002Fcomponents\u002FForm\u002FForm\u002FForm.pug";
pug_html = pug_html + "\u003Cinput" + (pug_attr("class", pug_classes(["form__button",data.buttons[1].attrs.class], [false,true]), false, false)+pug_attr("type", data.buttons[1].attrs.type, true, false)+pug_attr("value", data.buttons[1].attrs.value, true, false)+pug_attr("id", data.buttons[1].attrs.id, true, false)) + "\u002F\u003E\u003C\u002Fdiv\u003E";}.call(this,"data" in locals_for_with?locals_for_with.data:typeof data!=="undefined"?data:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line, pug_debug_sources[pug_debug_filename]);};return pug_html;}